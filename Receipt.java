...
public class Receipt {
    private LinkedList<Medicine> medicines = new LinkedList<Medicine>();
    ...
    public LinkedList<Medicine> getMed() {
        return medicines;
    }

    public LinkedList<Medicine> getMedIn() {
        return medicinesIn;
    }

    public LinkedList<Medicine> getMedOut() {
        return medicinesOut;
    }
